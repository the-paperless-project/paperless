...
class TestDate(TestCase):
    ...
    MOCK_SCRATCH = "paperless_ocrmypdf.parsers.PdfDocumentParser.SCRATCH"  # NOQA: E501
    ...
    def test_date_format_1(self):
        ...
        document = PdfDocumentParser(input_file)
    ...
    @mock.patch(
        "paperless_ocrmypdf.parsers.PdfDocumentParser.get_text",
        return_value="01-07-0590 00:00:00"
    )
    @mock.patch(MOCK_SCRATCH, SCRATCH)
    def test_crazy_date_past(self, *args):
        document = PdfDocumentParser("/dev/null")
        document.get_text()
    ...
    @mock.patch(
        "paperless_ocrmypdf.parsers.PdfDocumentParser."
        "FILENAME_DATE_ORDER",
    ...
    def test_filename_date_parse_invalid(self, *args):
        document = PdfDocumentParser("/tmp/20 408000l 2475 - test.pdf")
        document.get_text()
        self.assertIsNone(document.get_date())
